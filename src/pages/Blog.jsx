...
const Blog = () => {
  return (
    <div>
      ...
      <p className="uppercase font-blod text-3xl md:text-5xl text-orange-500 text-center my-10">
        Blog
      </p>
      <ul className="px-10 md:px-52 ">
        <li className="list-disc">
          <h1 className="text-2xl md:text-2xl uppercase my-5">
        ...
        <li className="list-disc">
          <h1 className="text-2xl md:text-2xl  uppercase my-5">How to validate React props using PropTypes</h1>
        ...
        <li className="list-disc">
          <h1 className="text-2xl md:text-2xl  uppercase my-5">Tell us the difference between nodejs and express js.</h1>
        ...
        <li className="list-disc">
          <h1 className="text-2xl md:text-2xl  uppercase my-5">What is a custom hook, and why will you create a custom hook?</h1>
